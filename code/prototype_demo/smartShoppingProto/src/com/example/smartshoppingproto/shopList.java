   ...
   // create an array of shops
	...
	private class GetShopAsyncTask extends AsyncTask<Hashtable<String,String>,Void,String>{
		  ...
		  protected String doInBackground(Hashtable<String,String>... params) {
		   ...
		   String json=HelperHttp.getJSONResponseFromURL("http://192.168.0.9/uniproject/shopList.php", ht);
		 ...
		 //after the jsonArray is created their values will be procesed in this method. Then they will be converted by
		  ...
		  protected void onPostExecute(String result){
			  ...
			  if(result=="SUCCESS")
			  {
			   Toast.makeText(shopList.this, "Success", Toast.LENGTH_SHORT).show();
			   ...
			   listv.setOnItemClickListener(new OnItemClickListener() {
				   ...
				   public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		              ...
		              Toast.makeText(shopList.this, name, Toast.LENGTH_SHORT).show();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.Button01)).setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				// hides the button from the UI once the task is executed
				 ((Button)findViewById(R.id.Button01)).setVisibility(View.GONE);
			}
        });
