	...
	private class GetGroceryAsyncTask extends AsyncTask<Hashtable<String,String>,Void,String>{
		...
		@Override
		  protected String doInBackground(Hashtable<String,String>... params) {
		   ...
		   String json=HelperHttp.postGroceryID("http://192.168.0.101:1234/uniproject/grocery.php",id);
		...
		final ListView listv=(ListView)findViewById(R.id.Item);
			...
			// the following line allows more than one item to be selected
			listv.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
			// attach the selector to the listview 
			listv.setSelector(R.drawable.selector);
			...
			//listener for the button 
			   Pay.setOnClickListener(new OnClickListener() {
			    	  public void onClick(View v) {
			    		  	...
			    		  	int price=0;
			    		  	// creates a response for the chosen items and  prints out the price 
			   ...
			   listv.setOnItemClickListener(new OnItemClickListener() {
				   public void onItemClick(AdapterView<?> parent, View view,
				     int position, long id) {
					   // gets the item at the position where the event occurred
