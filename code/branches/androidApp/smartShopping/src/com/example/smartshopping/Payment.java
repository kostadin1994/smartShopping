...
// a class which will execute the payment 
	private class PaymentAsyncTask extends AsyncTask<Hashtable<String,String>,Void,String>{
		  ...
		  protected String doInBackground(Hashtable<String,String>... params) {
		   ...
		   boolean Payment=HelperHttp.Pay("http://192.168.0.3:1234/uniproject/payment.php", username, Price);
		   if (Payment==true){
			   Editor editor = sp.edit();
			   editor.putInt("balance", newBalance);
			   editor.commit();
			   // if the payment is approved the user will be redirected to user page and balance will be updated to the session
			   Intent intent = new Intent(Payment.this, UserPage.class);
               startActivity(intent);  
